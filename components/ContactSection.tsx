          ...
          >
            ...
            <div className="space-y-7">
              {[
                ...
                { icon: <MapPin size={16} />, label: "Address", value: "Carlow, Co. Carlow, Ireland", href: undefined },
              ].map(({ icon, label, value, href }) => (
                <div key={label} className="flex items-start gap-5">
                  <div className="w-10 h-10 border border-stone flex items-center justify-center text-muted flex-shrink-0 mt-0.5">
                    {icon}
                  </div>
                  <div>
                    <p className="font-poppins text-xs tracking-widest uppercase text-muted mb-0.5">{label}</p>
                    {href ? (
                      <a href={href} className="font-poppins text-sm text-ink hover:text-irishred transition-colors">
                        {value}
                      </a>
                    ) : (
          ...
          >
            {sent ? (
              <div className="h-full flex flex-col items-start justify-center py-16">
                ...
                <h3 className="font-montserrat font-800 text-3xl text-ink mb-3">
                  Thank you.
                </h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                {[
                  ...
                  <div key={key} className="flex flex-col gap-1.5">
                    <label className="font-poppins text-xs tracking-widest uppercase text-muted">
                      {label}
                    </label>
                    <input
                      type={type}
                      ...
                      required
                      className="border border-stone px-4 py-3 font-poppins text-sm text-ink placeholder-muted focus:outline-none focus:border-ink transition-colors bg-transparent"
                    />
                  </div>
                ))}
                <div className="flex flex-col gap-1.5">
                  ...
                  <textarea
                    ...
                    required
                    rows={5}
                    className="border border-stone px-4 py-3 font-poppins text-sm text-ink placeholder-muted focus:outline-none focus:border-ink transition-colors bg-transparent resize-none"
                  />
                </div>
                <button
                  type="submit"
